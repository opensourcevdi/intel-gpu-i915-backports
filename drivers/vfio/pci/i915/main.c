...
#ifdef BPM_MIGRATION_GET_DATA_SIZE_NOT_PRESENT
static int i915_vfio_get_device_state_size(struct vfio_device *vdev,
		unsigned long *stop_copy_length)
{
	*stop_copy_length = I915_VFIO_MAX_DATA_SIZE;
	return 0;
}
#endif
...
#ifndef BPM_MIGRATION_STATE_MEMBER_NOT_PRESENT
...
static const struct vfio_migration_ops i915_vfio_pci_migrn_state_ops = {
	.migration_set_state = i915_vfio_pci_set_device_state,
	.migration_get_state = i915_vfio_pci_get_device_state,
#ifdef BPM_MIGRATION_GET_DATA_SIZE_NOT_PRESENT
	.migration_get_data_size = i915_vfio_get_device_state_size,
#endif
};
#endif
...
static int i915_vfio_pci_probe(struct pci_dev *pdev, const struct pci_device_id *id)
{
	...
	dev_info(&pdev->dev, "I915_VFIO_PCI BACKPORTED\n");
#endif
	...
	i915_vdev->vfid = vfid + 1;
	i915_vdev->pf = pdev->physfn;
	i915_vdev->pf_ops = &pf_ops;

	i915_vdev->core_device.vdev.migration_flags = VFIO_MIGRATION_STOP_COPY;
...
#ifdef BPM_MIGRATION_STATE_MEMBER_NOT_PRESENT
	i915_vdev->core_device.vdev.mig_ops = &i915_vfio_pci_migrn_state_ops;
#endif
...
#ifdef BPM_DRIVER_MANAGED_DMA_MEMBER_PRESENT
